...
def print_command_help(parser):
    ...
    This list of commands is generated by listing all the *.py files in the
    pyramidcms/commands directory and excluding __init__.py.
    ...
    command_help = '\n  '.join(commands)
    print('{}\navailable commands:\n  {}\n'.format(argparse_help, command_help))
