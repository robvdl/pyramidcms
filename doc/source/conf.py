...
# -*- coding: utf-8 -*-
#
# PyramidCMS documentation build configuration file, created by
...
project = 'PyramidCMS'
copyright = '2015, Rob van der Linde'
...
htmlhelp_basename = 'PyramidCMSdoc'
...
latex_documents = [
  ('index', 'PyramidCMS.tex', 'PyramidCMS Documentation',
   'Rob van der Linde', 'manual'),
]
...
man_pages = [
    ('index', 'pyramidcms', 'PyramidCMS Documentation',
     ['Rob van der Linde'], 1)
]
...
texinfo_documents = [
  ('index', 'PyramidCMS', 'PyramidCMS Documentation',
   'Rob van der Linde', 'PyramidCMS', 'One line description of project.',
   'Miscellaneous'),
]
